...
public class User {
    ...
    public User(Long chatId, String name, String introducedBudgetName, Category introducedCategory, UserState userState) {
        this.chatId = chatId;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(chatId, user.chatId) && Objects.equals(name, user.name) && Objects.equals(introducedBudgetName, user.introducedBudgetName) && introducedCategory == user.introducedCategory && userState == user.userState;
    }

    @Override
    public int hashCode() {
        return Objects.hash(chatId, name, introducedBudgetName, introducedCategory, userState);
    }
}
